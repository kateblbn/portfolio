...
if ($_POST) { // если передан массив POST
	...
	if (!$name or !$email or !$message) { // если хоть одно поле оказалось пустым
	...
	$emailgo->from_email= 'portfolio'; // от кого
	$emailgo->from_name= $email;
	$emailgo->to_email= 'kate.pidoni@gmail.com'; // кому
	...
	echo json_encode("Thank You. I'll contact with You soon"); // выводим массив ответа
}
